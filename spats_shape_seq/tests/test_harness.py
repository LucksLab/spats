...
class TestHarness:
    ...
    def run_testsets(self):
        for testset_dict in self.tests["tests"]:
            self.TestSet(self, testset_dict).run()   # TODO:  use a unittest.TestResult object

    def print_stats(self):
        pass # TODO:  use a unittest.TestResult object
    ...
    class TestSet(unittest.TestCase):
        ...
        def setUp(self):
            ...
            for key, value in self.testset_dict['run_opts'].iteritems():
                if (key == 'algorithms'):
                    self.algorithms = value
                else:
                    setattr(self.spats.run, key, value)
        ...
        def _check_expects(self, expects, pair, caseid):
            ...
            # TAI:  when test fails, diagram it
            # TODO:  increment stats in self.outer and/or unittest.TestResult object
